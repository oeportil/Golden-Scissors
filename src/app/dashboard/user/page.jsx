      ...
      <section className="parte1">
        <div className="p1 flex p-10">
          ...
          <div className="w-7/12">
            <div className="bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700 p-6">
          ...
          <div className="w-5/12 flex flex-col justify-center items-center">
            ...
            <Image src={foto} alt="Foto de perfil" className="w-24 h-24 rounded-full" />
