                ...
                <div className='grid gap-8 lg:grid-cols-2 text-justify items-center'>
                    <div className='flex flex-col items-center'>
                      <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. 
                        ...
                        <Link className='my-5 p-3 iniciar_sesion font-semibold' href='/login'>Inicia Sesión</Link>
                    </div>
                      <div className='grid gap-1 grid-cols-2 h-full'>
                          <Image className='' src={bar1} alt={'Introduccion de imagen'} priority/>
                          <Image className='lg:row-start-2 lg:col-start-2' src={bar2} alt={'Introduccion de imagen 2'} priority/>
                      </div>
                </div>
           </div> 
      </section>
